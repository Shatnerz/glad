#convert our_pal to pygame eqivalent
#and then used to create a gimp palette

our_pal = (0,0,0,8,8,8,16,16,16,24,24,24,32,32,32,40,40,40,48,48,48,56,56,56,1,
...
#for x in our_pal:
#  print "x: " + str(x)
#  print "our_pal index: " + str(our_pal_index)
#  print ""
#  our_pal_index += 1
pal = []
for x in range(256):
  a = [our_pal[x*3]*4, our_pal[x*3+1]*4, our_pal[x*3+2]*4, 255] #The numbers above seem to be 1/4th the values in the images
  for x in a:
    if x > 255: print "something went over"
  pal.append(a)
